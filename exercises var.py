#Exercie 1 : miles vers km

#miles = int(input('Please, enter your miles you want to convert in km : '))
#km = 1.60934

#print(f'Your miles in km are {miles*km}')

#Exercice 2 : échanger variables
