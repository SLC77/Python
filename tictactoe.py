# ### Creation d'un jeu Tic Tac Toe en python
...
# print()
# print("We have a match !", Player_1, "vs", Player_2, "!")
# print()
...
# ## - Designing a 3x3 grid for Tic Tac Toe Game

# print('Here it is, your battle arena !')

# def tittactoe_grid(value):
#     print('\n')
#     print('\t     |     |')
...
# ## - Validate Win or Tie situation

# # -- We'll determinate the win combinations
...
# # -- We'll determinate the tie conditions

# def tie_validate(position_player, player_current):
#     if len(position_player['X']) + len(position_player['O']) == 9:
#         return True
#     return False

# if win_validate(position_player, player_current):
#     tittactoe_grid(value)
#     print(player_current, "Won the game !")
#     print("\n")
...
def my_scoreboard(score_board):
    ...
    print("\t                    ",player_first,"VERSUS", player_second)
    print("\t              --------------------------------")  
    print("\t         The SCOREBOARD for TIC TAC TOE CHAMPIONSHIP      ")  
    print("\t              --------------------------------")  
